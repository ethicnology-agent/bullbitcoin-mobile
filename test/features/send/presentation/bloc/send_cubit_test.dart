  ...
  group('SendCubit multi-recipient sends', () {
    ...
    test(
      ...
      () async {
        ...
        ).thenThrow(NotEnoughFundsException());
    ...
    test('keeps the typed amount when a single remainder is built', () async {
      final wallet = _bitcoinLocalWallet();
      when(
        () => getWalletUtxosUsecase.execute(walletId: wallet.id),
      ).thenAnswer((_) async => const []);
      ...
      expect(cubit.state.amount, '10000');
