...
final class WalletSigningMaterialResolver {
  ...
  /// Takes ownership of [seed] as the private capability for [walletId].
  ///
  /// At most one wallet is loaded at a time: loading another clears the seed
  /// bytes of the one it replaces.
  void loadPrivateCapability({
    required String walletId,
    required MnemonicSeed seed,
  }) => _session.unlock(walletId: walletId, seed: seed);
