...
typedef ResolvedSweepInputs = ({List<WalletUtxo> selectedUtxos, int totalSat});
...
class ResolveSweepInputsUsecase {
  ...
  @useResult
  Future<Result<ResolvedSweepInputs, SendFailure>> execute({
    ...
    return Ok((
      ...
      totalSat: selected.fold(0, (sum, utxo) => sum + utxo.amountSat.toInt()),
    ));
  }
}
