...
import 'package:bb_mobile/features/passphrase_wallet/domain/ports/passphrase_wallet_deriver.dart';
import 'package:bb_mobile/features/passphrase_wallet/domain/ports/passphrase_wallet_scanner.dart';
...
abstract final class PassphraseWalletLocator {
  static void setup(GetIt locator) {
    locator.registerLazySingleton<PassphraseWalletDeriver>(
      BdkPassphraseWalletDeriver.new,
    );
    locator.registerLazySingleton<PassphraseWalletScanner>(
    ...
    locator.registerFactory<PassphraseWalletCubit>(() {
      ...
      return PassphraseWalletCubit(
        ...
        PreparePassphraseWalletUsecase(
          ...
          locator<GetSettingsUsecase>(),
          getWallets,
          locator<PassphraseWalletDeriver>(),
        ),
        ...
        ScanPassphraseWalletBalanceUsecase(locator<PassphraseWalletScanner>()),
        wallets,
      );
    });
  }
